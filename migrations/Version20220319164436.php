 ...
 */
final class Version20220319164436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO panier (id, produit_id, user_id, quantite, acheter) SELECT id, produit_id, user_id, quantite, acheter FROM __temp__panier');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__panier AS SELECT id, produit_id, user_id, quantite, acheter FROM panier');
        $this->addSql('DROP TABLE panier');
        $this->addSql('CREATE TABLE panier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, produit_id INTEGER DEFAULT NULL, user_id INTEGER DEFAULT NULL, quantite INTEGER NOT NULL, acheter BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO panier (id, produit_id, user_id, quantite, acheter) SELECT id, produit_id, user_id, quantite, acheter FROM __temp__panier');
        $this->addSql('DROP TABLE __temp__panier');
        $this->addSql('CREATE INDEX IDX_24CC0DF2F347EFB ON panier (produit_id)');
        $this->addSql('CREATE INDEX IDX_24CC0DF2A76ED395 ON panier (user_id)');
