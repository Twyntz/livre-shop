 ...
 */
final class Version20220318134913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__panier AS SELECT id, produit_id, user_id, quantitã©, acheter FROM panier');
        ...
        $this->addSql('INSERT INTO panier (id, produit_id, user_id, quantite, acheter) SELECT id, produit_id, user_id, quantitã©, acheter FROM __temp__panier');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_24CC0DF2F347EFB');
        $this->addSql('DROP INDEX IDX_24CC0DF2A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__panier AS SELECT id, produit_id, user_id, quantite, acheter FROM panier');
        $this->addSql('DROP TABLE panier');
        $this->addSql('CREATE TABLE panier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, produit_id INTEGER DEFAULT NULL, user_id INTEGER DEFAULT NULL, quantitã© INTEGER NOT NULL, acheter BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO panier (id, produit_id, user_id, quantitã©, acheter) SELECT id, produit_id, user_id, quantite, acheter FROM __temp__panier');
        $this->addSql('DROP TABLE __temp__panier');
        $this->addSql('CREATE INDEX IDX_24CC0DF2F347EFB ON panier (produit_id)');
        $this->addSql('CREATE INDEX IDX_24CC0DF2A76ED395 ON panier (user_id)');
    }
