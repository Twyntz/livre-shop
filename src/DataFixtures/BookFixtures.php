...
class BookFixtures extends Fixture
{
    public function load(ObjectManager $manager) {
		...
		foreach ($book_list as $book_data) {
            ...
            $book->setPrice($book_data['price']);
            $book->setPages($book_data['pages']);
            $book->setDescription($book_data['description']);
            $book->setImage($book_data['image']);
